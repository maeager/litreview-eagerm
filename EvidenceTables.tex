...
\usepackage{natbib} 
\usepackage{tabularx,booktabs,supertabular,lscape}
\usepackage{hhline} 
\usepackage{hyperref} \hypersetup{dvips, colorlinks=true,
...
%  \renewcommand\@evenhead{\@oddhead} \renewcommand\@oddfoot{\hfill
%%    }\textstylePageNumber{5/05/2011}} \renewcommand\@evenfoot{\@oddfoot}
%  \renewcommand\thepage{\arabic{page}} } \makeatother \pagestyle{Standard}
%\setlength\tabcolsep{1mm} \renewcommand\arraystretch{1.3} \newcounter{Table}

%\renewcommand\theTable{\arabic{Table}} \title{Table 1: Evidence of Connections}
...
\begin{landscape}
  \tablehead{\hline Connection & Transmitter/ Receptor & Synaptic Time Constant
    (msec) & Bandwidth (octaves or Q10) & No. of Synapses /Strength &
    Distribution & Delay\\\hline}
...
\begin{flushleft}
  \tablehead{\hline Cells & Cell body xsection area & Soma diameter & Dendrite span &
    Other\\\hline}
...
\begin{flushleft}
  \tablehead{\hline Stimuli & TS & DS & TV & Golgi & AN\\\hline}
...
\hline
             ...
             CS               &                     & \multicolumn{3}{|c|}{Percent number (total percent coverage area)} \\\hline
...
\begin{flushleft}
  \tablehead{}
  \begin{supertabular}{|m{6.2770004cm}|m{6.2770004cm}|m{6.3120003cm}|}
    \hline \citep{PalmerJiangEtAl:1996,
      ,PalmerWallaceEtAl:2003,PalmerWinter:1996,PaoliniClareyEtAl:2005,PaoliniClareyEtAl:2004,PaoliniClark:1999,PaoliniClarkEtAl:1997,PaoliniCotterillEtAl:1998,PaoliniCotterillEtAl:1998a}
    & Physiological characterisation plus reconstruction of cell axons and
    dendrites \citep{ArnottWallaceEtAl:2004} & \\\hline
  \end{supertabular}
\end{flushleft}
...
\begin{flushleft}
  ...
  \begin{supertabular}{m{6.044cm}m{2.442cm}m{2.442cm}m{2.442cm}m{2.442cm}m{2.442cm}}
    \hline & \multicolumn{5}{m{13.01cm}}{Model Type}\\\hhline{~-----} & I-c &
...
\begin{flushleft}
  \tablehead{\hline Connection &    Study &
    Synaptic Time Constant (msec) &
    Bandwidth (octaves) &
    No. of Synapses /Strength &
    Distribution &
    Delay\\\hline}
 ...
 &
     ...
     none\\\hline \multicolumn{1}{|m{2.993cm}}{} &
...
{ANI\ensuremath{\rightarrow}DS} &
   ...
   &
    ...
    \\\hline ANII\ensuremath{\rightarrow}G &
    ...
    \\\hline Granule\ensuremath{\rightarrow}G &
    ...
    \\\hline Golgi\ensuremath{\rightarrow}TS &
    ...
    \\\hline Golgi\ensuremath{\rightarrow}DS &
