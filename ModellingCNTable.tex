...
\caption{Connections  used in modeling studies} \\
\toprule  
                      Study                       &           Connections           & Synapse Model &           Connectivity Spread      (input BF rel to target BF)            & Synapse Strength              
                                                  & Delay \\ \midrule
\endfirsthead

\multicolumn{7}{c}{{\bfseries \tablename\ \thetable{} -- continued from previous page}} \\
                 \midrule  Study                  &           Connections           & Synapse Model &                            Connectivity Spread                            & Synapse Strength              
                                                  & Delay \\ \midrule
\endhead
