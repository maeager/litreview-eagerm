...
% \newlength\Tl \settowidth{\Tl}{Pressnitzer Meddis Et Al 2001} \setlength\tabcolsep{1mm}
\begin{longtable}{XXXXc}%
%
...
\toprule  
                           Study                             &                     Input Model                      &                          Neural Model                          &                    Connections                     & Parameter Selection      %& Synapse Model & Comments                             
\\ \midrule
\endfirsthead

\multicolumn{5}{c}{{\bfseries \tablename\ \thetable{} -- continued from previous page}} \\
                      \midrule  Study                        &                     Input AN Model                      &                          Neural Model                          &                    Connections                     & Parameter Selection     % & Synapse Model & Comments  
\\ \midrule
\endhead
...
\end{minipage}      & \begin{minipage}[c]{0.9in}  
Hand-tuned\\
Hand-tuned%fixed or variable
\end{minipage}  \\
%                                                             &                                                      &                                                                &        Inhibitory\ensuremath{\rightarrow}TS        & Hand-tuned
%                             %                               &                                                      & 
%\\ \midrule                                                                                                                                                                                                                                           
...
\end{minipage}  \\
 & Hand-tuned
                             %                               &       N = 6 or 15,        G =  8.5/n  or 2.0/n       & 1.7 ms                                                                                                                  
\\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                      {\ANFDS}                      & 
            %                                  %             &           {1/20 threshold for activation }           & 1.7 ms                                                                                                                  
% \\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                       \ANFTV                       & 
            %                                  %             &                  N = 21,   G=2.3/n,                  & 1.7 ms                                                                                                                  
% \\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                       \DSTS                        & 
            %                                  %             &        N = 3 or 8, G = 0.5/n or 1/n or 1.5/n         & 1.2$\pm$0.5 ms                                                                                                          
% \\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                       \DSTV                        & 
            %                                  %             &                 N = 8,     G = 1.5/n                 & 
% \\                                                                                                                                                                                                                                                    
...
%\\ \midrule                                                                                                                                                                                                                                           
 ...
 %            \multirow{3}{1in}{\citealp*{ReissYoung:2005}}  &                                                      &                                                                &                      {\ANFDS}                      & 
            %                                  %             &                      N*g = 10.8                      & 
% \\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                       \ANFTV                       & 
            %                                  %             &                       N*g = 23                       & 
% \\                                                                                                                                                                                                                                                    
            ...
            %                                  %             &                       N*g = 7                        & 
% \\ \midrule                                                                                                                                                                                                                                           
%           \multirow{3}{1in}{\citealp*{LomakinDavis:2008}}  &                                                      &                                                                &                      {\ANFDS}                      & 
            %                                  %             &                   N = 140 g = 0.05                   & --                                                                                                                      
% \\                                                                                                                                                                                                                                                    
                             %                               &                                                      &                                                                &                       \ANFTV                       & 
            %                                  %             &                   N = 48, g = 0.55                   & --                                                                                                                      
