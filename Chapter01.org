...
#+BEGIN_LaTeX
  \begin{figure}[htb] \centering %\def\svgwidth{5.5in}
    \includegraphics[width=\textwidth]{../LiteratureReview/gfx/CNcircuit-nodetail.png}
...
\PVCN with some in the posterior part of the \AVCN
...
\IC \citep{OertelWrightEtAl:2011}.  \Gls{TS} cells of the \VCN encode a robust
...
to modulation and onset delay of cells in the \CN
...
the middle ear and cochlea, and the specialised synapse between the \IHC and the \AN
...
\cite{Meddis:2006,MeddisHewittEtAl:1990,SumnerLopez-PovedaEtAl:2002}[fn:: DSAM 
http://www.essex.ac.uk/psychology/department/HearingLab/modelling.html] and the
Carney model
\cite{Carney:1993,TanCarney:2001,ZhangHeinzEtAl:2001,HeinzZhangEtAl:2001,TanCarney:2003,JacksonCarney:2005,ZilanyBruceEtAl:2009,ZilanyCarney:2010,ZilanyBruce:2006}[fn:: Carney
model
...
A number of neural models of \CN neurons have been developed.  The
basic approaches include point neuron models
\citep{ArleKim:1991,HewittMeddisEtAl:1992} and conductance based, \HH-like compartmental
models
...
\citep{WangSachs:1995,LaiWinslowEtAl:1994} and the model's synchronisation to envelope
