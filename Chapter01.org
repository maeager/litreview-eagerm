...
neuron's firing rate is significantly above their \SR.   The average bandwidth of \ANFs is \Qten
= 6.3 octaves \citep{JiangPalmerEtAl:1996}; where \Qten is the width of the
tuning curve at 10 dB above acoustic threshold at \CF divded by the \CF.
...
time constant of 0.36 msec in \TS and \DS cells, with a slight deviation in \TV
neurons (0.4 msec) \citep{Gardner:2000,GardnerTrussellEtAl:1999}.
...
GABAergic inputs to \TS cells have been verified by
optical microscopy immunohistochemistry
\citep{SmithRhode:1989,AwatramaniTurecekEtAl:2005,BabalianRyugoEtAl:2003} and electrophysiological
through the use of ionotopopheretic
...
the peri-olivary regions of the medulla in cats \citep{OstapoffBensonEtAl:1997}.  Slice
...
Only one electrophysiological study of the \GCD (or marginal shell
of the \VCN in cats) has been done and found monotonic responses in units assumed to be \GLG cells
\citep{GhoshalKim:1997}.
The assumed functional role of \GLG cells is to regulate granule cells but
the may also regulate the level of excitability in \DS and \TS cells \citep{GhoshalKim:1997,FerragamoGoldingEtAl:1998a}.
...
(synaptic delay) and 3 msec (2.5 msec conduction delay for an unmyelinated fibre of
0.5 mm plus 0.5 msec synaptic delay). Therefore \EPSPs with latencies of 3 msec are
...
inhibition can last for up to 400 msec, as observed by hyperpolarisation of
...
parameters in \BNNs.  Through this analysis, Chapter \ref{sec:GAChapter} demonstrates that \GAs
