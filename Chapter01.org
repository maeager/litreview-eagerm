...
neuron's firing rate is significantly above their \SR.  The average bandwidth of
...
\citep[see~review][]{RyugoParks:2003}.  Type 1 \ANFs are categorised into \HSR
and \LSR fibres \citep{Liberman:1978}.  \LSR fibres have relatively higher
thresholds, whereas \HSR fibres have thresholds close to 0 dB \SPL. Fibres of
similar \CF can vary in \SR from near 0 to 100 spikes/s.  The bi-modal \SR
distribution is present across the entire audible frequency range for the
animal, and implies a general organisational principle for the mammalian
\AN\@. \ANFs of the different \SR groupings exhibit distinct physiological
features, especially in terms of their contribution to the dynamic range of
hearing and representation of speech sounds \citep{RyugoParks:2003}.  The
collective evidence suggests that different \SR groupings of \ANFs play distinct
roles in acoustic information processing. It might be that the \HSR fibres with
their low thresholds function in quiet, whereas \LSR fibres with their high
...
robust representation of the stimulus spectrum in their average rate and a
...
output to the \IC\space \citep{SmithRhode:1989,OertelWuEtAl:1990}.  proximal
dendrites \citep{Cant:1981}. \TS cells are the primary excitatory The response
to acoustic stimulation is measured from a \PSTH to short tone bursts
...
DSAM model
(\citet{Meddis:2006,MeddisHewittEtAl:1990,SumnerLopez-PovedaEtAl:2002})\footnote{DSAM
http://www.essex.ac.uk/psychology/department/HearingLab/modelling.html} and the
Carney model
(\citet{Carney:1993,TanCarney:2001,ZhangHeinzEtAl:2001,HeinzZhangEtAl:2001,TanCarney:2003,JacksonCarney:2005,ZilanyBruceEtAl:2009,ZilanyCarney:2010,ZilanyBruce:2006})\footnote{Carney
model http://www.urmc.rochester.edu/labs/Carney-Lab/publications/auditory-models.cfm}.
...
rates.  \yellownote{Fix this sentence} Additionally, the \AN model, developed
