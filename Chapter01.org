...
#+begin_src emacs-lisp results: silent
    ...
    (add-to-list 'org-export-latex-classes '("UoM-draft-org-article"
      ...
      \\graphicspath{{./}{./gfx/}{../SimpleResponsesChapter/gfx/}{../figures/}{/media/data/Work/cnstellate/}{/media/data/Work/cnstellate/ResponsesNoComp/ModulationTransferFunction/}}
...
#+BEGIN_LaTeX
  \begin{landscape} 
  {\tiny\LTXtable{210mm}{/home/eagerm/Work/thesis/LiteratureReview/ModellingCNTable}}
  \end{landscape}
#+END_LaTeX
