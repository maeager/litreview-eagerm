...
The development of \BNN models is a major
objective of computational neuroscience.  Recent advances in the field have
made this goal more achievable than it has ever been before.  In
the auditory system, the high fidelity of acoustic information means synaptic
...
There is scope for more extensive exploitation of experimental data in the
design and optimisation of computational models.  There is a pressing need to
develop means to better integrate the experimental data. if we can successfully
do this we can improve the accuracy and value of BNN for use in the
...
utility of this approach for improving BNN models and using BNN models to help
understand complex neural processing.

This chapter justifies the choice of the stellate cell microcircuit as the focus
of the thesis. It describes the functional properties of TS cells in the
microcircuit, and provides a critical analysis of existing computational
models. This analysis is drawn upon in the design and optimisation of the CNSM
Model in the remainder of the thesis. This chapter concludes by providing an
overview of the thesis objectives and the subsequent chapters.
...
in the cochlear nucleus has been examined in detail in various species (cat:
...
Histology staining of the cochlear nucleus began eighty ago
...
experimental data are laid out in turn.  The \CNSM model was run through a series
of tone and noise stimuli for validation and analysed for each cell type.
...
optimisation, a faster means of establishing network parameters in BNNs.  Through this
analysis, Chapter 5 demonstrates that \GAs may have utility as an expedient
optimisation method for large \BNNs even where experimental data are limited.


Chapter 6 draws together the findings of the design and optimisation and the
